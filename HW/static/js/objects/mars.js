...
import { SUN_X, SUN_Y, SUN_Z, REAL_MARS_TO_SUN_DISTANCE, REAL_MARS_DIAMETER, REAL_MARS_ORBITAL_SPEED, REAL_MARS_ROTATIONAL_SPEED } from '../config/solarSystemConfig.js'
...
const GRAPHICS_PATH = '../../graphics/mars'
...
export class Mars {
    ...
    constructor(scene) {
        ...
        this.toParentDistance = get_scaled_planet_to_sun_dist(REAL_MARS_TO_SUN_DISTANCE)
        this.radius = get_scaled_planet_size(REAL_MARS_DIAMETER)
        this.orbitalSpeed = get_scaled_planet_orbital_speed(REAL_MARS_ORBITAL_SPEED)
        this.rotationalSpeed = get_scaled_planet_rotational_speed(REAL_MARS_ROTATIONAL_SPEED)
        ...
        let texture = textureLoader.load(`${GRAPHICS_PATH}/mars.jpg`)
