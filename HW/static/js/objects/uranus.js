...
import { SUN_X, SUN_Y, SUN_Z, REAL_URANUS_TO_SUN_DISTANCE, REAL_URANUS_DIAMETER, REAL_URANUS_ORBITAL_SPEED, REAL_URANUS_ROTATIONAL_SPEED } from '../config/solarSystemConfig.js'
...
const GRAPHICS_PATH = '../../graphics/uranus'
...
export class Uranus {
    ...
    constructor(scene) {
        ...
        this.toParentDistance = get_scaled_planet_to_sun_dist(REAL_URANUS_TO_SUN_DISTANCE)
        this.radius = get_scaled_planet_size(REAL_URANUS_DIAMETER)
        this.orbitalSpeed = get_scaled_planet_orbital_speed(REAL_URANUS_ORBITAL_SPEED)
        this.rotationalSpeed = get_scaled_planet_rotational_speed(REAL_URANUS_ROTATIONAL_SPEED)
        ...
        let texture = textureLoader.load(`${GRAPHICS_PATH}/uranus.jpg`)
