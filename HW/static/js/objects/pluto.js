...
import { SUN_X, SUN_Y, SUN_Z, REAL_PLUTO_TO_SUN_DISTANCE, REAL_PLUTO_DIAMETER, REAL_PLUTO_ORBITAL_SPEED, REAL_PLUTO_ROTATIONAL_SPEED } from '../config/solarSystemConfig.js'
...
const GRAPHICS_PATH = '../../graphics/pluto'
...
export class Pluto {
    ...
    constructor(scene) {
        ...
        this.toParentDistance = get_scaled_planet_to_sun_dist(REAL_PLUTO_TO_SUN_DISTANCE)
        this.radius = get_scaled_planet_size(REAL_PLUTO_DIAMETER)
        this.orbitalSpeed = get_scaled_planet_orbital_speed(REAL_PLUTO_ORBITAL_SPEED)
        this.rotationalSpeed = get_scaled_planet_rotational_speed(REAL_PLUTO_ROTATIONAL_SPEED)
        ...
        let texture = textureLoader.load(`${GRAPHICS_PATH}/pluto.jpg`)
        let material = new THREE.MeshStandardMaterial({map: texture})

        // bump
        const plutoBump = textureLoader.load(
            `${GRAPHICS_PATH}/plutobump.jpg`
        );
        material.bumpMap = plutoBump;
