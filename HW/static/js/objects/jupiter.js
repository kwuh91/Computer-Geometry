...
import { SUN_X, SUN_Y, SUN_Z, REAL_JUPITER_TO_SUN_DISTANCE, REAL_JUPITER_DIAMETER, REAL_JUPITER_ORBITAL_SPEED, REAL_JUPITER_ROTATIONAL_SPEED } from '../config/solarSystemConfig.js'
...
const GRAPHICS_PATH = '../../graphics/jupiter'
...
export class Jupiter {
    ...
    constructor(scene) {
        ...
        this.toParentDistance = get_scaled_planet_to_sun_dist(REAL_JUPITER_TO_SUN_DISTANCE)
        this.radius = get_scaled_planet_size(REAL_JUPITER_DIAMETER)
        this.orbitalSpeed = get_scaled_planet_orbital_speed(REAL_JUPITER_ORBITAL_SPEED)
        this.rotationalSpeed = get_scaled_planet_rotational_speed(REAL_JUPITER_ROTATIONAL_SPEED)
        ...
        let texture = textureLoader.load(`${GRAPHICS_PATH}/jupiter.jpg`)
