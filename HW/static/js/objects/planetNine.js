...
import { SUN_X, SUN_Y, SUN_Z, REAL_PLANET_NINE_TO_SUN_DISTANCE, REAL_PLANET_NINE_DIAMETER, REAL_PLANET_NINE_ORBITAL_SPEED, REAL_PLANET_NINE_ROTATIONAL_SPEED } from '../config/solarSystemConfig.js'
...
const GRAPHICS_PATH = '../../graphics/planetNine'
const textureLoader = new THREE.TextureLoader();

export class PlanetNine {

    constructor(scene) {
        this.phi = 0
        
        this.toParentDistance = get_scaled_planet_to_sun_dist(REAL_PLANET_NINE_TO_SUN_DISTANCE)
        this.radius = get_scaled_planet_size(REAL_PLANET_NINE_DIAMETER)
        this.orbitalSpeed = get_scaled_planet_orbital_speed(REAL_PLANET_NINE_ORBITAL_SPEED)
        this.rotationalSpeed = get_scaled_planet_rotational_speed(REAL_PLANET_NINE_ROTATIONAL_SPEED)
        ...
        let texture = textureLoader.load(`${GRAPHICS_PATH}/planetNine.jpg`)
