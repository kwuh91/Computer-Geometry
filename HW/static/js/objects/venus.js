...
import { SUN_X, SUN_Y, SUN_Z, REAL_VENUS_TO_SUN_DISTANCE, REAL_VENUS_DIAMETER, REAL_VENUS_ORBITAL_SPEED, REAL_VENUS_ROTATIONAL_SPEED } from '../config/solarSystemConfig.js'
...
const GRAPHICS_PATH = '../../graphics/venus'
...
export class Venus {
    ...
    constructor(scene) {
        ...
        this.toParentDistance = get_scaled_planet_to_sun_dist(REAL_VENUS_TO_SUN_DISTANCE)
        this.radius = get_scaled_planet_size(REAL_VENUS_DIAMETER)
        this.orbitalSpeed = get_scaled_planet_orbital_speed(REAL_VENUS_ORBITAL_SPEED)
        this.rotationalSpeed = get_scaled_planet_rotational_speed(REAL_VENUS_ROTATIONAL_SPEED)
        ...
        let texture = textureLoader.load(`${GRAPHICS_PATH}/venus.jpg`)
